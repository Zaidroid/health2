    ...
    interface AuthContextType {
      ...
      signUp: (email?: string, password?: string, name?: string) => Promise<void>; // Add name parameter
    ...
    export function AuthProvider({ children }: { children: React.ReactNode }) {
      ...
      const signUp = async (email?: string, password?: string, name?: string) => { // Add name parameter
        setLoading(true);
        try {
